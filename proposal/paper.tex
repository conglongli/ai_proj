...
\date{}
\title{\textbf{\TITLE 15-780 Project Proposal\\ Use ILP to Evaluate Indirection Scheduling Techniques for Hybrid Circuit/Packet Networks}}
\author{{\large Conglong Li (andrew ID conglonl), Thomas Kim (andrew ID tskim)}\\
{\em $\left\{conglonl, thomas.kim\right\}@cs.cmu.edu$}}
